...
public class Cliente {
    ...
    public String getCnpjCpf() {
        return this.tipoPessoa == TipoPessoa.JURIDICA ? this.cnpj : this.cpf;
    }

    public String getDocumentoFormatado() {
        if (this.tipoPessoa == TipoPessoa.JURIDICA) {
            return this.cnpj != null ? this.cnpj : "CNPJ Não Informado";
        } else {
            return this.cpf != null ? this.cpf : "CPF Não Informado";
        }
    }
}